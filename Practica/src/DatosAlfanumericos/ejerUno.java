...
/*
 * 1. Determinar si un carácter es un digito numérico 
 * (función esDigito(char c)).
 * 2. Determinar si un carácter es una letra (función esLetra(char c)).
 * 3. Determinar si un carácter es una letra mayúscula o minúscula (función esMayuscula(char c) y esMinuscula(char c)).
 * 4. Determinar la longitud de una cadena (función longitud)
 * 5. Determinar si una cadena es vacía (función esVacia)
 * 6. Concatenar dos cadenas (función concatenarCadena)
